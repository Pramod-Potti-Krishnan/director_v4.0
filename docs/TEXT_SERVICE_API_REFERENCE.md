...
## ⭐ GOLD STANDARD: 34 Tested & Approved C1 Variants

These 34 variants have been **tested and approved** for production use. They are the recommended choice for content slides.
...
```json
{
  ...
  "slide_spec": {
    ...
    "slide_purpose": "Brief description of what this slide conveys",
    "key_message": "The main takeaway for the audience",
    "context": "Presentation context (e.g., Enterprise, Education)",
...
{
  "success": true,
  "html": "<div style='...'>...generated HTML content...</div>",
  "variant_id": "grid_2x2_centered_c1",
  "metadata": {...}
}
```

### Gold Standard Variant List (34 total)

| Category | Variants |
|----------|----------|
| **Grid (9)** | `grid_2x2_centered_c1`, `grid_2x2_left_c1`, `grid_2x2_numbered_c1`, `grid_2x3_c1`, `grid_2x3_left_c1`, `grid_2x3_numbered_c1`, `grid_3x2_c1`, `grid_3x2_left_c1`, `grid_3x2_numbered_c1` |
| **Table + Quote (5)** | `table_2col_c1`, `table_3col_c1`, `table_4col_c1`, `table_5col_c1`, `impact_quote_c1` |
| **Layout (12)** | `single_column_3section_c1`, `single_column_4section_c1`, `single_column_5section_c1`, `asymmetric_8_4_3section_c1`, `asymmetric_8_4_4section_c1`, `asymmetric_8_4_5section_c1`, `sequential_3col_c1`, `sequential_4col_c1`, `sequential_5col_c1`, `comparison_2col_c1`, `comparison_3col_c1`, `comparison_4col_c1` |
| **Metrics, Matrix, Hybrid (8)** | `metrics_2x2_grid_c1`, `metrics_3col_c1`, `metrics_3x2_grid_c1`, `metrics_4col_c1`, `matrix_2x2_c1`, `matrix_2x3_c1`, `hybrid_left_2x2_c1`, `hybrid_top_2x2_c1` |

---

## ⭐ GOLD STANDARD: 26 Tested & Approved I-Series Variants

These 26 I-series variants have been **tested and approved** for production use. They combine AI-generated images with structured content layouts.

### API Contract

**Endpoint**: `POST /v1.2/iseries/{I1|I2|I3|I4}`
...
```json
{
  ...
  "title": "Slide Title",
  "subtitle": "Subtitle",
  "narrative": "Content narrative describing the slide purpose",
  "topics": ["Topic 1", "Topic 2", "Topic 3"],
  "visual_style": "illustrated",
  "image_prompt_hint": "specific visual subject for the image",
  "content_style": "bullets",
  "max_bullets": 6,
  "content_variant": "sequential_3col_i1",
  "skip_image_generation": false,

  // Director Brand Parameters (optional but recommended)
  "global_brand": {
    "target_demographic": "enterprise executives, corporate leadership aesthetic",
...
**Response** (see Part 5 for full schema):
```json
{
  "image_html": "<div style='...'><img src='...' .../></div>",
  "title_html": "<h2 style='...'>Slide Title</h2>",
  "subtitle_html": "<p style='...'>Subtitle</p>",
  "content_html": "<div class='sequential-container'>...</div>",
  "image_url": "https://storage.googleapis.com/deckster-hero-images/...",
  "image_fallback": false,
  "slide_title": "<h2 style='...'>Slide Title</h2>",
  "subtitle": "<p style='...'>Subtitle</p>",
  "body": "<div class='sequential-container'>...</div>",
  ...
  "metadata": {
    ...
    "image_prompt": "sleek modern photorealistic image of [image_prompt_hint]...",
    "topics": ["Topic 1", "Topic 2", "Topic 3"],
    "image_error": null
  }
}
...
### Gold Standard I-Series Variant List (26 total)

| Category | Variants |
|----------|----------|
| **Single Column (12)** | `single_column_3section_i1`, `single_column_3section_i2`, `single_column_3section_i3`, `single_column_3section_i4`, `single_column_4section_i1`, `single_column_4section_i2`, `single_column_4section_i3`, `single_column_4section_i4`, `single_column_5section_i1`, `single_column_5section_i2`, `single_column_5section_i3`, `single_column_5section_i4` |
| **Comparison (8)** | `comparison_2col_i1`, `comparison_2col_i2`, `comparison_2col_i3`, `comparison_2col_i4`, `comparison_3col_i1`, `comparison_3col_i2`, `comparison_3col_i3`, `comparison_3col_i4` |
| **Sequential (6)** | `sequential_3col_i1`, `sequential_3col_i2`, `sequential_3col_i3`, `sequential_3col_i4`, `sequential_4col_i3`, `sequential_4col_i4` |

> **Note**: Sequential 4-col is only available for I3/I4 (narrow image layouts). Wide layouts (I1/I2) do not support 4-col sequential due to content space constraints.

### Layout Specifications

| Layout | Image Position | Image Size | Aspect Ratio | Content Area |
|--------|---------------|------------|--------------|--------------|
| **I1** | Left (wide) | 660×1080px | **2:3** | 1200×840px |
| **I2** | Right (wide) | 660×1080px | **2:3** | 1140×840px |
| **I3** | Left (narrow) | 360×1080px | **9:16** | 1500×840px |
| **I4** | Right (narrow) | 360×1080px | **9:16** | 1440×840px |

> **Important**: The Image Builder API uses the aspect ratio to generate appropriately sized images. I1/I2 use 2:3 (portrait wide), while I3/I4 use 9:16 (portrait narrow/tall).

### Image Prompt Construction

When `global_brand` is provided (recommended for Director integration):
```
[visual_style] image of [image_prompt_hint] with [action]. [lighting_mood]. [color_palette]. [target_demographic].
```

Example with `global_brand`:
- Input: `image_prompt_hint`: "cloud computing servers data center"
- Input: `global_brand.visual_style`: "sleek modern photorealistic"
- Output: "sleek modern photorealistic image of cloud computing servers data center with elegant flowing composition. professional dramatic lighting, sophisticated atmosphere. cool blues and metallic silvers. enterprise executives, corporate leadership aesthetic."

**Key Point**: The `image_prompt_hint` becomes the **anchor subject** that makes each slide's image unique. Always provide a specific, descriptive hint (e.g., "cloud computing servers data center") rather than generic terms.

### Character Limits by Variant Type

**Sequential Variants:**
| Variant | Layout | Chars/Bullet | Bullets/Step |
|---------|--------|--------------|--------------|
| `sequential_3col_i1` / `sequential_3col_i2` | Wide (I1/I2) | 40-55 (baseline 47) | 5 |
| `sequential_3col_i3` / `sequential_3col_i4` | Narrow (I3/I4) | 50-75 (baseline 65) | 5 |
| `sequential_4col_i3` / `sequential_4col_i4` | Narrow (I3/I4) | 35-50 (baseline 42) | 5 |

**Single Column Variants:**
| Variant Type | Layout | Chars/Bullet | Bullets/Section |
|--------------|--------|--------------|-----------------|
| `single_column_Xsection_i1/i2` | Wide | 40-85 chars | 6 |
| `single_column_Xsection_i3/i4` | Narrow | 40-85 chars | 6 |

**Comparison Variants:**
| Variant Type | Layout | Items/Column |
|--------------|--------|--------------|
| `comparison_2col_iX` | All | 6 bullets |
| `comparison_3col_iX` | All | 6 bullets |
...
| **Content Generation** | 3 | 34 | Variant-based content (Gold Standard C1) |
| **Hero Slides** | 7 | 12 | Title, section, closing |
| **I-Series** | 7 | 26 | Image + text layouts (Gold Standard) |
| **Layout/Element API** | 14 | - | Granular generation |
| **Async Jobs** | 5 | - | Job-based processing |

**Total**: 53 endpoints, 60 Gold Standard variants (34 C1 + 26 I-Series)
...
### Supported variant_id Values

> **⭐ RECOMMENDED**: For **Gold Standard** production-ready variants (34 C1 variants), see the [Gold Standard section](#-gold-standard-34-tested--approved-c1-variants) at the top of this document.

**Bronze Tier** (legacy, not fully tested - use with caution):

| Category | variant_id values (Bronze - Legacy) |
|----------|-------------------------------------|
...
> **Important**: The Image Builder uses aspect ratio for correct image generation. I1/I2 = 2:3 (portrait), I3/I4 = 9:16 (tall portrait).
...
```json
{
  ...
  "content_variant": "sequential_3col_i1",      // Optional: specific variant

  // Image configuration
  "visual_style": "illustrated",                // "professional"|"illustrated"|"kids"
  "image_prompt_hint": "professional team",     // IMPORTANT: This is used as anchor subject

  // Director Brand Parameters (optional but recommended for consistency)
  "global_brand": {
    "target_demographic": "enterprise executives",
    "visual_style": "sleek modern photorealistic",
    "color_palette": "cool blues and metallic silvers",
    "lighting_mood": "professional dramatic lighting"
  },
...
```json
{
  ...
  "metadata": {
    ...
    "image_aspect_ratio": "2:3",                // "2:3" for I1/I2, "9:16" for I3/I4
    ...
    "image_prompt": "sleek modern photorealistic image of professional team...",
    "topics": ["Engineering", "Design", "Operations"],
    "image_error": null                         // Error message if image failed, otherwise null
  }
}
```
...
```json
{
  ...
  "image_prompt_hint": "modern technology abstract",  // IMPORTANT: Used as anchor subject
  "visual_style": "illustrated",                // "professional"|"illustrated"|"kids"

  // Director Brand Parameters (for consistent styling across deck)
  "global_brand": {
    "target_demographic": "enterprise executives",
    "visual_style": "sleek modern photorealistic",
    "color_palette": "cool blues and metallic silvers",
...
```json
{
  ...
  "metadata": {
    ...
    // Diagnostic fields (always included)
    "image_prompt": "sleek modern photorealistic image of modern technology abstract...",
    "topics": ["Speed", "Reliability", "Cost"],
    "image_error": null                           // Error string if image failed, else null
  }
}
```
...
|---------|------|---------|
| 1.2.5 | Dec 2024 | Added `global_brand` parameter for Director integration, `image_prompt_hint` as anchor subject, new metadata fields (`image_prompt`, `topics`, `image_error`), image aspect ratios (2:3/9:16) |
| 1.2.4 | Dec 2024 | Added Gold Standard I-Series section (26 variants: 12 single column, 8 comparison, 6 sequential) |
